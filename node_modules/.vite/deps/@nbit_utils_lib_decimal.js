...
var require_decimal = __commonJS({
  "node_modules/.pnpm/decimal.js@10.4.3/node_modules/decimal.js/decimal.js"(exports, module) {
...
// node_modules/.pnpm/@nbit+utils@1.0.1-beta.31/node_modules/@nbit/utils/lib/decimal/index.js
var require_decimal2 = __commonJS({
  "node_modules/.pnpm/@nbit+utils@1.0.1-beta.31/node_modules/@nbit/utils/lib/decimal/index.js"(exports) {
    "use strict";
    ...
    var Decimal__default = _interopDefaultLegacy(Decimal);
    ...
    var removeDecimalZero = (val) => {
      const regexp = /(?:\.0*|(\.\d+?)0+)$/;
      val = `${val}`.replace(regexp, "$1");
      return val;
    };
    var formatNumberDecimal = (data, digits = 2, isRound, delPostZero) => {
    ...
    var formatCurrency = (data, digits, keepDigits = true, isRound) => {
...
// dep:@nbit_utils_lib_decimal
var nbit_utils_lib_decimal_default = require_decimal2();
export {
  nbit_utils_lib_decimal_default as default
};
/*!
 *  decimal.js v10.4.3
 ...
 *  MIT Licence
 */
//# sourceMappingURL=@nbit_utils_lib_decimal.js.map
