...
__export(src_exports, {
  default: () => vaviteReloaderPlugin
});
module.exports = __toCommonJS(src_exports);
var import_crypto = __toESM(require("crypto"));
function vaviteReloaderPlugin({
  entry = "/server",
  reloadOn = "any-change",
  ...
  return {
    ...
    enforce: "pre",
    buildStart() {
      globalSymbol = "VAVITE_HTTP_DEV_SERVER_" + import_crypto.default.randomBytes(20).toString("hex");
    },
    closeBundle() {
      delete global[globalSymbol];
    },
    resolveId(source) {
      if (source === "@vavite/reloader/http-dev-server" || source === "vavite/http-dev-server") {
