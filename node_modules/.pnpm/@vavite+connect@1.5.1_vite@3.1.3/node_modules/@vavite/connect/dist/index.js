...
__export(src_exports, {
  default: () => vaviteConnect
});
module.exports = __toCommonJS(src_exports);
var import_path = __toESM(require("path"));
var import_url = __toESM(require("url"));
var import_meta = {};
var dirname = typeof __dirname === "undefined" ? import_url.default.fileURLToPath(new URL(".", import_meta.url)) : __dirname;
      ...
      async resolveId(id) {
        if (id === "/virtual:vavite-connect-handler") {
          ...
          return import_path.default.resolve(
            dirname,
            clientAssetsDir ? bundleSirv ? "entry-standalone-bundled-sirv.mjs" : "entry-standalone-imported-sirv.mjs" : "entry-standalone.mjs"
          );
        }
      }
    },
