...
import { getMemberUserInfo, getMemberBaseSettingsInfo, postMemberAuthRefreshToken } from '@/apis/user'
...
function getStore(set, get) {
  return {
    ...
    c2cModeUserInfo: {} as any,
    setC2cModeUserInfo: c2cUserInfo => {
      set(
...
const subPublicC2cToken = baseUserStore.subscribe(
  ...
  async isLogin => {
    if (isLogin) {
      ...
      baseUserStore.getState().setC2cModeUserInfo({})
    }
  }
)
