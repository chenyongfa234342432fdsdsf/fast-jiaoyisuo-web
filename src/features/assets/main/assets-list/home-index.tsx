...
export function HomeAssetsList(props: IAssetsListProps) {
        ...
        assetsListData.map(item => (
          <Link key={item.coinId} href={`/assets/main/detail?cid=${item.coinId}`} className="coin-item">
            ...
            <div className="coin-val-wrap">
              ...
              >
                <div className="home-coin-val">
                  <AssetsEncrypt
                    content={
                      <>
                        <span className="home-total-amount">
                          {formatCoinAmount(item.symbol, item.totalAmount.toString())}
                        </span>
                        <span className="total-price">
                          {rateFilter({ symbol: item.symbol, amount: item.totalAmount.toString() })}
                        </span>
                      </>
                    }
                  />
